  ...
  Widget showImageCropButtonsBorder(state) {
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: CustomPaint(
          painter:
              FrameHolePainter(targetSize: Size(cropSizeWidth, cropSizeHeight)),
          child: Container(
            width: cropSizeWidth,
            ...
            decoration: BoxDecoration(
              border: Border.all(
                color: Colors.white,
                width: widget.squareBorderWidth ?? 1,
              ),
            ),
          ),
        ),
...
class FrameHolePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      Path()
        ..moveTo(startX + targetSize.width / 3, startY)
        ..lineTo(startX + targetSize.width / 3, startY + targetSize.height),
      paintRectangle,
    );
    canvas.drawPath(
      Path()
        ..moveTo(startX + targetSize.width * 2 / 3, startY)
        ..lineTo(startX + targetSize.width * 2 / 3, startY + targetSize.height),
      paintRectangle,
    );
    canvas.drawPath(
      Path()
        ..moveTo(startX, startY + targetSize.height / 3)
        ..lineTo(startX + targetSize.width, startY + targetSize.height / 3),
      paintRectangle,
    );
    canvas.drawPath(
      Path()
        ..moveTo(startX, startY + targetSize.height * 2 / 3)
        ..lineTo(startX + targetSize.width, startY + targetSize.height * 2 / 3),
      paintRectangle,
    );
  }
